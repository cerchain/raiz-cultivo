          ...
          return (
            <div className="fade">
              ...
              {subs.map(sub=>{
                ...
                const tareasDelSub = (esEjecutor ? tareas.filter(t=>t.asignado_a===usuario.id) : tareas).filter(t=>t.sector_id===sub.id);
                    ...
                    {cosechas.map(c=>{
                      ...
                      return (
                        <div key={c.id} style={{background:"#141e10",border:`1px solid ${g?.color||"#2a4a2a"}44`,borderRadius:"14px",padding:"16px",borderLeft:`4px solid ${g?.color||"#4a6a4a"}`}}>
                          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"12px"}}>
                            <div>
                              <div style={{fontSize:"16px",fontWeight:"600",color:"#e0f0d0",marginBottom:"4px"}}>{g?.nombre||"—"}{c.numero_lote?` · ${loteLabel(c.numero_lote)}`:""}</div>
