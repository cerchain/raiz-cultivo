          ...
          <div className="fade">
            ...
            <div style={card({borderColor:"#0e6a5a",background:"#0a1e1a"})}>
              <div onClick={()=>setTiposTareaAbierto(!tiposTareaAbierto)} style={{cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:tiposTareaAbierto?"12px":"0"}}>
                <span style={{...lbl("#16a085"),margin:0}}>🗂 DATOS MAESTROS <span style={{color:"#5a9a8a",fontWeight:"400"}}>· Tipos de tarea · {tiposTarea.length}</span></span>
            ...
            <div style={{marginBottom:"14px"}}>
              <div onClick={()=>setEstructuraAbierto(!estructuraAbierto)} style={{cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 16px",borderRadius:"12px",border:"1px solid #3a2a4a",background:"#140e1c",marginBottom:estructuraAbierto?"10px":"0"}}>
