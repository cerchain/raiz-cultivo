      ...
      <div style={{background:"var(--c013)",minHeight:"100vh",fontFamily:"'IBM Plex Mono',monospace",color:"var(--c014)"}}>
        <div style={{background:"var(--c102)",borderBottom:"2px solid var(--c006)",padding:"18px 20px"}}>
          ...
          {usuario.es_master_grower && misSalasComoMG.length>0 && (
            <button onClick={()=>entrarModoMG()} title="Cambiar a modo Master Grower"
    ...
    return (
      <div style={{background:"var(--c107)",minHeight:"100vh",fontFamily:"'IBM Plex Mono',monospace",color:"var(--c014)"}}>
        ...
        <div style={{padding:"20px"}}>
          ...
          <div style={{fontSize:"12px",color:"var(--c038)",marginBottom:"14px"}}>{todasEntidades.length} entidad{todasEntidades.length!==1?"es":""} · {salasTodas.length} sala{salasTodas.length!==1?"s":""}</div>
                      ...
                      <div key={sala.id} style={{background:"var(--c170)",border:"1px solid var(--c006)",borderRadius:"10px",padding:"12px"}}>
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px",gap:"8px"}}>
                          <div>
                            ...
                            <div style={{fontSize:"11px",color:mg?"var(--c082)":"var(--c010)",marginTop:"3px"}}>{mg?"Master Grower: "+mg.nombre+(mg.activo===false?" (desactivado)":""):"⚠ Sin Master Grower asignado"}</div>
                          </div>
                        ...
                        {mg && (
                          <button onClick={()=>eliminarMasterGrowerAdmin(mg)} style={{padding:"5px 9px",borderRadius:"7px",fontSize:"10px",background:"var(--c111)",color:"var(--c003)",border:"1px solid var(--c171)",marginBottom:"9px"}}>⏸ Quitar como Master Grower</button>
                        )}
                        {!mg && (
                          <button onClick={()=>setEditingMGAdmin({nombre:"",email:"",salaNombre:"",salaIdExistente:sala.id})} style={{padding:"5px 9px",borderRadius:"7px",fontSize:"10px",background:"var(--c044)",color:"var(--c001)",border:"1px solid var(--c045)",marginBottom:"9px"}}>+ Asignar Master Grower</button>
                        )}
                        ...
                        <div style={{display:"flex",flexDirection:"column",gap:"5px"}}>
                          {miembros.map(u=>(
                            <div key={u.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",background:"var(--c110)",borderRadius:"8px",padding:"7px 11px",opacity:u.activo===false?0.5:1}}>
    ...
    <div style={{fontFamily:"'IBM Plex Mono',monospace",background:"var(--c074)",minHeight:"100vh",color:"var(--c019)"}}>
      ...
      <div style={{background:"var(--c055)",borderBottom:"2px solid var(--c025)",padding:"18px 20px 16px",position:"sticky",top:0,zIndex:100}}>
        {usuario.rol==="administrador" && adminEntidadModo==="mg" && (
          <button onClick={volverModoEntidad} title="Volver al panel de administración"
            style={{display:"inline-flex",alignItems:"center",gap:"6px",marginBottom:"12px",padding:"6px 12px",borderRadius:"20px",fontSize:"12px",fontWeight:"600",background:"var(--c013)",color:"var(--c015)",border:"1px solid var(--c006)",cursor:"pointer"}}>
            <span style={{fontSize:"11px"}}>‹</span> 🏢 <span>Modo Administrador</span>
            <span style={{fontSize:"10px",opacity:0.75,fontWeight:"400"}}>· {entidadNombre}</span>
          </button>
        )}
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          <div>
