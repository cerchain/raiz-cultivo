        ...
        return (
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.75)",display:"flex",alignItems:"center",justifyContent:"center",padding:"20px",zIndex:200}}>
            <div style={{background:"var(--c073)",border:"1px solid var(--c011)",borderRadius:"16px",padding:"22px",width:"100%",maxWidth:"380px"}}>
              ...
              {destinoEnFloracion && (()=>{
                const diasEnFlo = subDestElegido.fecha_inicio_floracion
                  ? Math.max(0, Math.floor((new Date() - new Date(subDestElegido.fecha_inicio_floracion+"T00:00:00")) / 86400000)) : 0;
                return (
                  <div style={{background:"var(--c094)",border:"1px solid var(--c088)",borderRadius:"10px",padding:"12px 14px",marginBottom:"16px"}}>
                    ...
                    <div style={{fontSize:"11px",color:"var(--c022)",lineHeight:"1.55"}}>
                      Esa carpa arrancó floración el {subDestElegido.fecha_inicio_floracion} ({diasEnFlo}d). Todas las plantas de una carpa comparten el mismo reloj, así que estas plantas van a figurar con {diasEnFlo}d de floración desde el día uno, y su fecha de corte va a salir desfasada.
                    </div>
