                        ...
                        {lotesSub.map(l=>{
                          ...
                          return (
                            <div key={l.id} style={{background:"#111e11",borderRadius:"8px",padding:"10px 12px",border:`1px solid ${g?.color||"#2a4a2a"}44`}}>
                              ...
                              <div style={{fontSize:"11px",color:"#4a6a4a",marginBottom:"6px"}}>Desde {l.fecha_ultima_movida||l.fecha_inicio} · {Math.max(0,Math.round((new Date()-new Date(l.fecha_ultima_movida||l.fecha_inicio))/86400000))}d en {sp.nombre.toLowerCase()}</div>
