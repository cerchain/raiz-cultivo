...
function RaizApp() {
  ...
  if(!usuario) {
    ...
    if(inviteId) return <Invitacion usuarioId={inviteId} onIrALogin={()=>{ window.history.replaceState({},"",window.location.pathname); setModoAuth("login"); }} />;
              ...
              return (
                <div key={u.id} style={{background:"#12162a",borderRadius:"10px",padding:"10px 14px",opacity:u.activo===false?0.5:1,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  <div>
                    ...
                    <div style={{fontSize:"10px",color:"#5a6a9a",marginTop:"2px"}}>{rolLabel}{u.es_master_grower?" + MG":""}{u.activo===false?" · INACTIVO":""}</div>
                  </div>
                  {u.id!==usuario.id && (
    ...
    return (
      <div style={{background:"#0e0e16",minHeight:"100vh",fontFamily:"'IBM Plex Mono',monospace",color:"#dfe0f0"}}>
        ...
        <div style={{padding:"20px"}}>
          ...
          {entidadesSinUso.length > 0 && (
            <div style={card({background:"#1a1608",borderColor:"#5a4a20"})}>
              <span style={lbl("#d0a840")}>⚠ ENTIDADES SIN NINGUNA SALA ({entidadesSinUso.length})</span>
              <div style={{fontSize:"11px",color:"#a89060",marginBottom:"10px"}}>Se crean vía signup público. Candidatas a borrar si quedaron abandonadas a mitad de registro.</div>
              <div style={{display:"flex",flexDirection:"column",gap:"6px"}}>
                {entidadesSinUso.map(ent=>(
                  <div key={ent.id} style={{display:"flex",flexDirection:"column",gap:"6px",background:"#0e0e22",borderRadius:"8px",padding:"10px 12px"}}>
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <span style={{fontSize:"12px",color:"#c8c8e8"}}>{ent.nombre}</span>
