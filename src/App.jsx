                          ...
                          return (
                            <div key={l.id} style={{background:"#111e11",borderRadius:"8px",padding:"10px 12px",border:`1px solid ${g?.color||"#2a4a2a"}44`}}>
                              ...
                              <div style={{display:"flex",gap:"6px"}}>
                                ...
                                {!esEjecutor && sigPadre && (
                                  <button onClick={()=>{setMovingLote(l); setDestinoSub("");}} style={{flex:1,padding:"7px",borderRadius:"7px",fontSize:"11px",background:`${colorDeFase(sigPadre.orden)}22`,color:colorDeFase(sigPadre.orden),border:`1px solid ${colorDeFase(sigPadre.orden)}66`}}>→ Avanzar a {sigPadre.nombre}</button>
                                )}
                                {!esEjecutor && !sigPadre && (
