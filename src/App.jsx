...
function RaizApp() {
    ...
    (async()=>{
      try {
        ...
        if(email){
          ...
          else localStorage.removeItem("raiz_email");
        }
      } catch(e) {}
      setLoaded(true);
    })();
  ...
  const enviarMensaje = async () => {
    ...
    try {
      const res = await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:nuevosApiMsgs,contextoCultivo:buildContexto()})});
