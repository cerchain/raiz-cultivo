...
function RaizApp() {
  ...
  return (
    <div style={{fontFamily:"'IBM Plex Mono',monospace",background:"var(--c074)",minHeight:"100vh",color:"var(--c019)"}}>
      ...
      <div style={{background:"var(--c055)",borderBottom:"2px solid var(--c025)",padding:"14px 16px 12px",position:"sticky",top:0,zIndex:100}}>
          ...
          <div style={{minWidth:0,flex:1}}>
            ...
            {usuario.rol==="administrador" && adminEntidadModo==="mg" && (
              <button onClick={volverModoEntidad} title="Volver al panel de administración"
                style={{display:"inline-flex",alignItems:"center",gap:"6px",marginTop:"10px",padding:"6px 12px",borderRadius:"20px",fontSize:"12px",fontWeight:"600",background:"var(--c013)",color:"var(--c015)",border:"1px solid var(--c006)",cursor:"pointer"}}>
