    ...
    <div style={{fontFamily:"'IBM Plex Mono',monospace",background:"var(--c074)",minHeight:"100vh",color:"var(--c019)"}}>
      ...
      <div style={{display:"none"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"10px"}}>
          <div style={{minWidth:0,flex:1}}>
            <div style={{fontFamily:"'DM Serif Display',serif",fontSize:"20px",color:"var(--c001)",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>🌱 RAÍZ</div>
            <div style={{fontSize:"10px",color:"var(--c174)",letterSpacing:"1px",marginTop:"2px",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>
              {usuario.nombre} · {esEjecutor?"EJECUTOR":usuario.rol==="administrador"?"MASTER GROWER":"MASTER GROWER"}
              {(() => {
                const nombreSalaActual = salaActualNombre || entidadSalas.find(s=>s.id===salaId)?.nombre;
      ...
      <div style={{padding:"20px 20px 110px"}}>
        ...
        {tab==="_relevamientos" && (()=>{
          ...
          return (
            <div className="fade">
              <div style={{fontFamily:"'DM Serif Display',serif",fontSize:"22px",color:"var(--c030)",marginBottom:"6px"}}>📦 Inventario</div>
              <div style={{fontSize:"13px",color:"var(--c068)",marginBottom:"18px"}}>CONTEO FÍSICO DE PLANTAS POR SUBSECTOR</div>
              ...
              {puedeRelevar && (
                editingRelevamiento ? (
                  ...
                  <button onClick={()=>setEditingRelevamiento(emptyRelevamiento())} style={{width:"100%",padding:"14px",borderRadius:"12px",fontSize:"14px",fontWeight:"600",background:"var(--c215)",color:"var(--c030)",border:"2px dashed var(--c095)",marginBottom:"20px"}}>+ Nuevo conteo</button>
                )
              )}

              {relevamientos.length===0 ? (
                <div style={{textAlign:"center",padding:"40px 20px",color:"var(--c216)",fontSize:"14px"}}>Sin conteos de inventario registrados</div>
              ) : (()=>{
                const porDia = {};
